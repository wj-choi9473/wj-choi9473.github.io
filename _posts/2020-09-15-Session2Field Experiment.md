...
특히 ch2에선 의학연구에서 사용되는 유형의 무작위 실험이 질문들에 접근하는 하나의 이상적인 벤치마크를 제공한다는 말의 의미를 논의합니다. 
...
E[Y_{1i}\mid D_i = 1] - E[Y_{0i}\mid D_i = 0] - (E[Y_{0i}\mid D_i = 1]  - E[Y_{0i}\mid D_i = 0] )$
...
$Y = \alpha + \beta X + \epsilon$ 에서 $X = D_i$일때, 간단히 그냥  $\beta$값을 구한다면 $\beta$값은 biased 될 수 밖에 없습니다.   
왜냐면 $D_i$가 random이 아니고 endogenous 하기 때문입니다.   
...
[논문](https://wj-choi9473.github.io/%EB%85%BC%EB%AC%B8/Do-TargetedDiscountOffersServeasAdvertising/)
